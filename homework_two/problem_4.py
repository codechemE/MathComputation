...
print(climate_table)
print(f"The yearly temperature average is {mean_temp} (°F), the average monthly rainfall is {mean_rainfall} inches. "
      f"The yearly average sunshine is {mean_sunshine} hours.")